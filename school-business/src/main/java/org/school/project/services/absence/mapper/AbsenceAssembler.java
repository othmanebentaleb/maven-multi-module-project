...
public class AbsenceAssembler extends Assembler<AbsenceDto, Absence> {
    ...
    public AbsenceDto toDto(Absence model) {
        ...
        if(Objects.nonNull(model.getStudent())) {
            ...
            Student studentModel = model.getStudent();
            ...
            studentDto.setParentInfo(new ParentInfoDto());
            studentDto.getParentInfo().setAdress(studentModel.getParentInfo().getAdress());
            studentDto.getParentInfo().setFatherEmail(studentModel.getParentInfo().getFatherEmail());
            studentDto.getParentInfo().setFatherPhone(studentModel.getParentInfo().getFatherPhone());
            studentDto.getParentInfo().setId(studentModel.getParentInfo().getId());
            studentDto.getParentInfo().setFatherProfession(studentModel.getParentInfo().getFatherProfession());
            studentDto.getParentInfo().setMotherPhone(studentModel.getParentInfo().getMotherPhone());
            studentDto.getParentInfo().setMotherProfession(studentModel.getParentInfo().getMotherProfession());
            studentDto.getParentInfo().setResidencePhone(studentModel.getParentInfo().getResidencePhone());
        }
