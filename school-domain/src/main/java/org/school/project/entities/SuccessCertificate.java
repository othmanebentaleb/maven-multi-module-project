...
public class SuccessCertificate {
    ...
    @JoinColumn(name = "id_E", unique=false, nullable=true, insertable=true, updatable=true)
    private Student student;

    @OneToOne(fetch = FetchType.EAGER, cascade=CascadeType.MERGE,  optional = false)
    @JoinColumn(name = "id_A", unique=false, nullable=true, insertable=true, updatable=true)
    private Year year;
